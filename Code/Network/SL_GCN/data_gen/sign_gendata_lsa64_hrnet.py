...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/sign_lsa64/')
    ...
    for points in pointsl:
        ...
        data_paths = ["/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/train", 
                    "/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/val", 
                    "/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/test"]
        label_paths = ["/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/lsa64_train.csv", 
                    "/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/lsa64_val.csv", 
                    "/raid/zhengjian/OpenHands/datasets/LSA64/lsa64_cut/all_npy_splits/lsa64_test.csv"]
        for i in range(3):
            gendata(
                data_paths[i],
                label_paths[i],
