...
def gendata(data_path, label_path, out_path, part='train', config='27'):
    ...
    # 读取并使用csv标签文件,  保证 data 和 labels 次序一一对应
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/sign_include/')
    ...
    for points in pointsl:
        ...
        for splits in all_splits:
            ...
            print(splits)
            label_path = "/raid/zhengjian/AUTSL-Recognition/Code/Dataset_splits/INCLUDE/Correction/Train_Test_Split_manual/{}_include_wo_Second(Number).csv".format(splits)
