...
"""
see Code/Skeleton/Network/SL_GCN/readme.md 
ex. python sign_gendata.py  --points 27_cvpr  
"""
sys.path.extend(['../'])
...
def gendata(data_path, label_path, out_path, part='train', config='27'):
    ...
    print(fp.shape)  # ({split_num}, 150, 27, 3, 1)  xxx: 34995\2331\3500
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/sign_gsl/')
    ...
    for points in points_l:
        ...
        data_root = "/raid/zhengjian/OpenHands/datasets/GSL/Greek_isolated/all_npy/"


        for splits in all_splits:

            print(splits)
            label_path = "/raid/zhengjian/HA-SLR-GCN/Code/Dataset_splits/GSL/Correction/{}_greek_iso.csv".format(splits)
...
"""
$ python sign_gendata_gsl_hrnet.py
../data/sign_gsl/27_cvpr
train
(34995, 150, 27, 3, 1)
(34995, 3, 150, 27, 1)
val
