...
tag = '27_cvpr_sl_lgcn_alpha_hands_baseline'      # '27'  'cvpr'
tag1l = ['acc', 'loss']   #  'acc'  'loss'
tag2l = ['train', 'test']   # ['val', 'test']

d1 = f"INCLUDE_joint_{tag}_test"
d2 = f"INCLUDE_bone_{tag}_test"
d3 = f"INCLUDE_joint_motion_{tag}_test"
d4 = f"INCLUDE_bone_motion_{tag}_test"
d = [d1, d2, d3, d4]
...
for tag1 in tag1l:
    for tag2 in tag2l:
        ...
        label = open(f"../data/sign_include/27_cvpr/{tag2}_label.pkl", 'rb')
